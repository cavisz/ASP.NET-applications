<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LocaisEditar.aspx.cs" Inherits="LocaisEditar" %>
                ...
                <div class="col-lg-6 col-md-8 col-sm-10" style="margin: 0 auto">
                    <div class="card border-secondary mb-3">
                        <div class="card-header" style="text-align: center">
                            <h5>Cadastro de Locais</h5>
                        </div>
                        <br />
                        <div class="card-body">
                            <div class="row form-group">
                                <asp:Label ID="lbl_sigla" runat="server" Text="Sigla:" CssClass="col-3"></asp:Label>
                                <div class="col-9">
                                    <asp:TextBox ID="txt_sigla" runat="server" CssClass="form-control" MaxLength="10"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                                        runat="server"
                                        ControlToValidate="txt_sigla"
                    ...
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <div class="col" style="text-align: right">
                            <asp:Button ID="btn_excluir" runat="server" Text="Exluir" CssClass="btn btn-outline-danger" ToolTip="Excluir Local" OnClick="btn_excluir_Click" />
