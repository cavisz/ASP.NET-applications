                ...
                <asp:View ID="View1" runat="server">
                    <div class="row">
                        <div class="col-md-3" style="margin-top: 10px; margin-bottom: 5px">
                            <asp:TextBox ID="txt_pesquisa" runat="server" class="form-control" MaxLength="149"></asp:TextBox>
                        </div>
                        <div class="col">
                ...
                <asp:View ID="View2" runat="server">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <asp:TextBox CssClass="form-control" ID="txt_nome" runat="server" MaxLength="149"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col">
                            <asp:Button ID="btn_salvar" runat="server" Text="Salvar" CssClass="btn btn-outline-secondary" OnClick="btn_salvar_Click" OnClientClick="JavaScript:checkEmail(); checkRamal();" />
